...
*** Variables ***
${wfname}    TC1728WF8974_Called_Node_var
...
*** Test Cases ***
Login user TC    
    Log To Console    ED3.8_WORKFLOW-8974_02 Add multiple conditions and treatment for a variable in Variables node for a ruleset then run Call Intercept To Called WFD including IFTTT task    
    ...
    browser_03.Edit Rules Callintercept    ${ruleset_name}    ${EXTENSION1}    NO    ${PROMPT}    ${CALLING_VARIABLE_CALLINTERCEPT}
    

    Log To Console    4. Make a call that satisfies both conditions    
    
    browser_03.Add Route Called Party    ${wfname}    ${wfname}    ${PRIORITY_1}    ${EXTENSION2}
