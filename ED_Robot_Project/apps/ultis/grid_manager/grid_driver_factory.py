...
from selenium.webdriver.chrome.options import Options  # web guide
from selenium.webdriver.common.desired_capabilities import DesiredCapabilities  # web guide
...
#         options = Options() # web guide
#         options.add_argument('--allow-running-insecure-content') # web guide
#         options.add_argument('--ignore-certificate-errors') # web guide

#         desired_capabilities = DesiredCapabilities.CHROME.copy() # web guide
        
        desired_capabilities = CHROME
        
        desired_capabilities['acceptInsecureCerts'] = True  # web guide to fix certificate when https
